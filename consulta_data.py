...
# Agrega el directorio Bantel a la ruta SYS
...
class ClsData:
    ...
    def __init__(self, data_base):
        ...
        self.odata = datos_profit(host=os.getenv("HOST_PRODUCCION_PROFIT"), 
    ...
    def ultimo_plan_facturado(self):
        ...
        ultimas_facturas = df.groupby(['co_cli'], sort=False, as_index=False)[['fec_emis', 'doc_num']].max()
